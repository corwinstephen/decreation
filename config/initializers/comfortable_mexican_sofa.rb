...
ComfortableMexicanSofa::AccessControl::AdminAuthentication.username = ENV['CMS_ADMIN_USERNAME'] || "decreation"
ComfortableMexicanSofa::AccessControl::AdminAuthentication.password = ENV['CMS_ADMIN_PASSWORD'] || "G7ZBn3Uf"
